...
$stmt = $conn->prepare("INSERT INTO data1(Name, FatherName, MotherName, Birthdate, AdmissionSession, RegistrationID, Batch, Address, MobileNo, Email, Amount, BankName, TransactionID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
